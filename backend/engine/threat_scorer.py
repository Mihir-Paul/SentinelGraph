...
# Configurable deterministic security event scoring weights
...
EVENT_REASONS: Dict[str, str] = {
    ...
    "SUCCESSFUL_LOGIN": "Successful authentication following prior failed attempts or suspicious activity.",
...
def calculate_severity(score: int) -> str:
    """
    Determines threat severity deterministically from numerical score (0-100).
    0-30   = LOW
    31-60  = MEDIUM
    61-80  = HIGH
    81-100 = CRITICAL
